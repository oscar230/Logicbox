namespace Logicbox.App.Models
{
    internal abstract class NNode : INNode
    {
        ...
        /// <returns></returns>
        internal static bool AreSiblings(INNode nodeA, INNode nodeB)
        {
        ...
        /// <param name="nodeB"></param>
        /// <returns></returns>
        internal static bool AreNeighbors(INNode nodeA, INNode nodeB)
        {
        ...
        internal static bool IsForest(IEnumerable<INNode> nodes)
        {
            throw new NotImplementedException();
        }

        internal static IEnumerable<INNode> RootNodesInForest(IEnumerable<INNode> nodes)
        {
            if (IsForest(nodes))
            {
        ...
        internal static bool IsBinaryTree(INNode rootNode)
        {
